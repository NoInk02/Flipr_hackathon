(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_admin_[username]_[companyid]_page_tsx_ddcc80._.js", {

"[project]/app/admin/[username]/[companyid]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CompanyDetails() {
    ...
    const [selectedTab, setSelectedTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Company Details');
    ...
    const [faqList, setFaqList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [originalFaqList, setOriginalFaqList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [newAgentUsername, setNewAgentUsername] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [newAgentPassword, setNewAgentPassword] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [editingAgentId, setEditingAgentId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [editingAgentPassword, setEditingAgentPassword] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [editingPasswordError, setEditingPasswordError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CompanyDetails.useEffect": ()=>{
            const fetchCompany = {
                "CompanyDetails.useEffect.fetchCompany": async ()=>{
                    try {
                        ...
                        setCompany(data);
                        setFormData(data);
                        const initialFaqList = Object.entries(data.faqDICT).map({
                            "CompanyDetails.useEffect.fetchCompany.initialFaqList": ([question, answer], index)=>({
                                    id: `faq-${index}`,
                                    question,
                                    answer
                                })
                        }["CompanyDetails.useEffect.fetchCompany.initialFaqList"]);
                        setFaqList(initialFaqList);
                        setOriginalFaqList(initialFaqList);
                    } catch (error) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Error fetching company');
                    } finally{
                        setLoading(false);
                    }
                }
            }["CompanyDetails.useEffect.fetchCompany"];
    ...
    const handleAddAgent = ()=>{
        ...
        if (formData.helpers.some((agent)=>agent.helperID === newAgentUsername)) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Agent with this username already exists');
            return;
        }
        setFormData((prev)=>({
                ...prev,
    ...
    const handleUpdate = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Company updated successfully');
    ...
    const handleDelete = async ()=>{
        if (window.confirm('Are you sure you want to delete this company?')) {
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Company deleted successfully');
                router.push(`/admin/${username}`);
            } catch (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Error deleting company');
            }
        }
    };
    ...
    const handleFileUpload = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Files uploaded successfully');
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Error uploading files');
        } finally{
...
_s(CompanyDetails, "WLPpT9rY2Jb3Hh4YcpimT4BH1Dk=", false, function() {
    return [
...
_c = CompanyDetails;
var _c;
__turbopack_refresh__.register(_c, "CompanyDetails");
...
//# sourceMappingURL=app_admin_%5Busername%5D_%5Bcompanyid%5D_page_tsx_ddcc80._.js.map